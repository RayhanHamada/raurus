...
| -------- | -------------------------- | ----------------------------------------------------------- |
| `GET`    | `/`                        | Health check                                                |
| `GET`    | `/metadata`                | List metadata (optional `?placeholderIds`)                  |
| `GET`    | `/metadata/:placeholderId` | Get single metadata record                                  |
| `PUT`    | `/metadata/:placeholderId` | Upsert metadata (photo/video with assetKey, text with text) |
| `GET`    | `/asset-content/:assetKey` | Stream raw asset content                                    |
| `POST`   | `/upload-asset`            | Upload asset file → returns assetKey                        |
| `GET`    | `/presigned-url`           | Get presigned upload URL                                    |
| `GET`    | `/presigned-download-url`  | Get presigned download URL                                  |
| `DELETE` | `/asset/:assetKey`         | Delete asset                                                |
