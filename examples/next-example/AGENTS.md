...
- **RaurusClientProvider integration** — The root layout wraps children in `<RaurusClientProvider url="http://localhost:3000" enableEdit>`, providing edit-mode state to all pages
